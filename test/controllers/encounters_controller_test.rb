...
class EncountersControllerTest < ActionController::TestCase
  ...
  test "should create encounter" do
    assert_difference('Encounter.count') do
      post :create, encounter: { bill_id: @encounter.bill_id, doctor_name: @encounter.doctor_name, patient_name: @encounter.patient_name }
    end
  ...
  test "should update encounter" do
    patch :update, id: @encounter, encounter: { bill_id: @encounter.bill_id, doctor_name: @encounter.doctor_name, patient_name: @encounter.patient_name }
    assert_redirected_to encounter_path(assigns(:encounter))
  end
